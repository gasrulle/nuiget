...
export const ChevronRightIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
...
export const ChevronDownIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const SettingsGearIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: warning */
export const WarningIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: close (x) */
export const CloseIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const CheckIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: arrow-right */
export const ArrowRightIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: arrow-left */
export const ArrowLeftIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const CloudDownloadIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: info */
export const InfoIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const SyncIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const RulerIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const LoadingIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
...
export const ClearAllIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: trash */
export const TrashIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const VerifiedIcon = React.memo<IconProps>(({ size = 14, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
        <path fillRule="evenodd" clipRule="evenodd" d="M14.431 3.323l-8.47 10-.79-.036-3.35-4.77.818-.574 2.978 4.24 8.051-9.506.763.646z" />
    </svg>
...
export const ExternalLinkIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: add (plus) */
export const PlusIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const ArrowUpIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const SingleProjectIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
export const AllProjectsIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
        <g opacity="0.55">
...
export const ShieldIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: expand-all */
export const ExpandAllIcon = React.memo<IconProps>(({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
