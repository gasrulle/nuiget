...
export const CollapseAllIcon: React.FC<IconProps> = ({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: expand-all */
export const ExpandAllIcon: React.FC<IconProps> = ({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
...
/** Codicon: filter */
export const FilterIcon: React.FC<IconProps> = ({ size = defaultSize, className, title, style }) => (
    <svg width={size} height={size} viewBox="0 0 16 16" fill="currentColor" className={className} style={style} aria-hidden={!title} role={title ? 'img' : undefined}>
        {title && <title>{title}</title>}
